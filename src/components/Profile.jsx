...
// const Profile = () => {
//     const {id} = useParams(); //id of the foodpartner
//     console.log("Id of foodpartner is",id)
...
//         .then(response=>{
//           console.log("The response from the backend is",response.data)
...
//   return (
//     <>
//     <div>This is the profile of {first?.foodPartner?.name}</div>
//     <div>This is the profile of {first?.foodPartner?.email}</div>
//     <div>Total Items is {first?.foodItemsOfPartner?.length}</div>
//     <div> 
//       <p>Videos uploaded by {first?.foodPartner?.name}</p>
//       <br />
//       {first?.foodItemsOfPartner?.map((items)=>{
//         return(
//           <>
//           {console.log("The items are",items)}
//           {/* {setcount(prevcount=>prevcount+1)} */}
//             <video src={items.video} width={100} height={100} controls>
//             </video>
//           </>
//         )
//       })}
          ...
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden mb-6">
            ...
            <div className="pt-16 px-6 sm:px-8 pb-6">
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-6">
                ...
                <button className="bg-gradient-to-r from-orange-500 to-red-500 text-white font-semibold py-3 px-8 rounded-full hover:shadow-lg transform hover:scale-105 transition-all duration-200 flex items-center justify-center space-x-2">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
